...
export const dict: Record<Locale, Dictionary> = {
	pt: {
		...
		hero: {
			...
			sub: 'Centro de estética profissional em Lisboa. Massagens, limpeza de pele, manicure, pedicure e depilação — com o cuidado que merece.',
			book: 'Agendar Agora',
		...
		about: {
			...
			subtitle:
				'Bem-vindo ao nosso centro de estética em Lisboa! Oferecemos uma ampla variedade de serviços de cuidados pessoais, incluindo massagens relaxantes e terapêuticas, drenagem linfática, limpeza de pele e tratamentos de rosto, manicure, pedicure e depilação.',
	...
	en: {
		...
		hero: {
			...
			title2: 'every visit',
			sub: 'Professional aesthetics center in Lisbon. Massages, skin cleansing, manicure, pedicure, and waxing — with the care you deserve.',
			book: 'Book Now',
		...
		about: {
			...
			subtitle:
				'Welcome to our aesthetic center in Lisbon! We offer a wide variety of personal care services, including relaxing and therapeutic massages, lymphatic drainage, skin cleansing and facial treatments, manicure, pedicure, and waxing.',
